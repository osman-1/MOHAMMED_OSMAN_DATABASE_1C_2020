...
#insert_records.insert_one_record_one_table("INSERT IGNORE INTO t_user (id_user, Nom) VALUES (null, %(values_insert)s)",
...
sql = "INSERT INTO t_user (Nom, Prenom) VALUES (%s, %s)"
val = ("John", "osman")
