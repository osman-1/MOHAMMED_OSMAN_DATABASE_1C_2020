...
insert_records.insert_one_record_one_table("INSERT IGNORE INTO t_fournisseur (Id_fournisseur, fournisseur) VALUES (null, %(values_insert)s)",valeur_debile_mais_presque_aleatoire_a_inserer)
