...
try:
    ...
    print("material ",valeur_genre, "; numero_ligne_table_update ",numero_ligne_table_update)
    ...
    valeur_update_dictionnaire = {'material': valeur_genre, 'no_ligne_update': numero_ligne_table_update}

    # Pour la mise à jour on doit avoir au moins deux valeurs "numero_ligne_table_update" et "valeur_genre"
    mysql_update_string = "UPDATE t_material SET material = %(material)s WHERE id_material = %(no_ligne_update)s"
