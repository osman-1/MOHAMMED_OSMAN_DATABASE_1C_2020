...
# Pour cette nouvelle route le langage HTML est dans une page séparée dans le répertoire "templates"
# Flask doit avoir ce répetoire "templates" pour placer nos pages HTML.
# Une route "/presentation" est définie, elle retourne une page nommée "templates/presentation.html"
# Pour la tester http://127.0.0.1:5002/presentation
@obj_mon_application.route('/presentation')
def about():
...
# Pour la tester http://127.0.0.1:5002/la_quatrieme_route/ChangerCetteValeur
#
...
def traitement_param_input_url(nom_input_url):
    ...
    # Dans le fichier "templates/about.html" on récupère les 3 variables
    # "nom_dans_fichier_html", "nom_reverse_fichier_html" et "nom_complet_url_fichier_html"
    return render_template("about.html",
                           nom_dans_fichier_html=nom_input_url,
                           nom_reverse_fichier_html=reverse_nom_input_url,
